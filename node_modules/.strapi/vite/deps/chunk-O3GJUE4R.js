import {
  ...
  QueryClientProvider,
  img
} from "./chunk-LHDPGKTM.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-2DK6Z2G7.js";
import {
  useAIAvailability,
  useNpsSurveySettings
} from "./chunk-DB4KJCXQ.js";
import {
  useGetAIUsageQuery
} from "./chunk-562OSEXD.js";
import {
  GuidedTourContext
} from "./chunk-DB3ZZQVE.js";
import {
  require_pick
} from "./chunk-DO3OXFMZ.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-I3QHHKCV.js";
import {
  useEnterprise
} from "./chunk-PCUGDS6X.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-HPB5AZU2.js";
import {
  Login
} from "./chunk-QHUP57NT.js";
import {
  MemoizedInputRenderer
} from "./chunk-UL3C4WIM.js";
import {
  Form
} from "./chunk-DGQQ3YTD.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-VB7LYAEJ.js";
import {
  ConfigurationProvider
} from "./chunk-V3KCRNWB.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-FNMNDQ6S.js";
import {
  require_baseRest
} from "./chunk-BD7A7K74.js";
import {
  HistoryProvider
} from "./chunk-Y5GJSSDN.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-U4C7YDBF.js";
import {
  Layouts
} from "./chunk-ZXFANZFI.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-BX6LVJCS.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-FKEYUFOT.js";
import {
  getByteSize
...
} from "./chunk-DALJ3QWQ.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-5A2RKWBJ.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-ZAMTU3NZ.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-QXGDIOYQ.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-Y2UFXJOS.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-TVIC67OT.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-7NG2PSUG.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BLMIOQOP.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-7ARPYM4P.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-VOBCSMRI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-7QZUZOWY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-6ILXD77W.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-KJD2S347.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-4ZGMKC5L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MOBFYW3Z.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-R3BC3WRZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-YGLTJI5B.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-USXKKFU4.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-OVAC3YB2.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-YTG5THQK.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-YOK4J7ZI.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-7GSC3T7O.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-AKTJT7AW.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-LZQZ2S3G.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-CV35NO7E.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-HTGBMLQ6.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-HZS6NA6O.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-XS2ST5LA.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-5QXD7JWZ.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-FV2V4CKK.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-4IHDN2DV.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-N5VNWGHV.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-2NHS2ARB.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-2NHS2ARB.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-7DHOJHI5.js");
...
//# sourceMappingURL=chunk-O3GJUE4R.js.map
