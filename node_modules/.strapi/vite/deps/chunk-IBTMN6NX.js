import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-AC5H37C7.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-GXPVWYHY.js";
import {
  LimitsModal
} from "./chunk-WZSBDTPB.js";
import {
...
} from "./chunk-5E7EJI5P.js";
import {
  useTypedSelector
} from "./chunk-AHNBBTX7.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-XJZTWCIR.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-AK5RIIGO.js";
import {
  index
} from "./chunk-AIOCSQIL.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-Y4U4CBQP.js";
import {
  useConfig,
  useTracking
} from "./chunk-7KOCHY3F.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-QNDMAG3E.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-6Z7QIKZK.js";
import {
  renderAdmin
} from "./chunk-O3GJUE4R.js";
import {
  useAIAvailability
} from "./chunk-DB4KJCXQ.js";
import {
  useLicenseLimits
} from "./chunk-WG4375GD.js";
import {
  Table,
  useTable
} from "./chunk-GNF72DTZ.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-HT6QQHHV.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-VJGBJYGY.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-PQAFNEPJ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-K7NN4NCK.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-YP5QLW4F.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-53UFPZO7.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-G4AAXXMA.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-6KNCZI3L.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-5TMIPFYC.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-X4KRXCDB.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-7ZYL27XZ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-6I5UKKFD.js");
          return {
...
//# sourceMappingURL=chunk-IBTMN6NX.js.map
